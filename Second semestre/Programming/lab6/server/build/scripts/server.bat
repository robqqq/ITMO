...
set CLASSPATH=%APP_HOME%\lib\server-1.0.jar;%APP_HOME%\lib\common-1.0.jar;%APP_HOME%\lib\logback-classic-1.2.3.jar;%APP_HOME%\lib\slf4j-api-1.7.30.jar;%APP_HOME%\lib\logback-core-1.2.3.jar
